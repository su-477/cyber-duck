    ...
    */
    ...
    function initLang() {
        ...
        if (self.langLocation == 1) {
            ...
            $.ajax({
                type: "GET",
                url: "https://pmprojectv3.purplemediahosting.co.uk/classroomAPI/LanguageAPI/getcontentItemSetByType?langID=" + self.langID + "&type=1&projectid=" + projectID,
                async: true,
                crossDomain: true,
            }).done(function (nav) {
                self.lang.nav = nav;
            ...
            $.ajax({
                type: "GET",
                url: "https://pmprojectv3.purplemediahosting.co.uk/classroomAPI/LanguageAPI/getcontentItemSetByType?langID=" + self.langID + "&type=2&projectid=" + projectID,
                async: true,
                crossDomain: true,
            }).done(function (scorm) {
            ...
            $.ajax({
                type: "GET",
                url: "https://pmprojectv3.purplemediahosting.co.uk/classroomAPI/LanguageAPI/getcontentItemSetByType?langID=" + self.langID + "&type=3&projectid=" + projectID,
                async: true,
                crossDomain: true,
            }).done(function (kc) {
                self.lang.kc = kc;
            ...
            $.ajax({
                type: "GET",
                url: "https://pmprojectv3.purplemediahosting.co.uk/classroomAPI/LanguageAPI/getcontentItemSetByType?langID=" + self.langID + "&type=4&projectid=" + projectID,
                async: true,
                crossDomain: true,
            ...
            $.ajax({
                type: "GET",
                url: "https://pmprojectv3.purplemediahosting.co.uk/classroomAPI/LanguageAPI/getprojectPages?langID=" + self.langID + "&projectid=" + projectID,
                async: true,
                crossDomain: true,
            }).done(function (pages) {

const DevOpsController = function () {
    const self = this;
    this.endPoint = 'https://purpledev.visualstudio.com/' + moduleController.projectURL;
    ...
    this.doLogin = function (pat) {
        ...
        $.ajax({
            type: "GET",
            url: 'https://purpledev.visualstudio.com/_apis/projects/?api-version=5.1',
            async: true,
            crossDomain: true,
    ...
    this.init = function () {
        ...
        $.ajax({
            type: "GET",
            url: 'https://purpledev.visualstudio.com/_apis/projects/' + moduleController.projectURL + '/teams?api-version=5.1',
            async: true,
            crossDomain: true,
            beforeSend: function (xhr) {
            ...
            $.ajax({
                type: "GET",
                url: 'https://purpledev.visualstudio.com/_apis/projects/' + moduleController.projectURL + '/teams/' + teamId + '/members?api-version=5.1',
                async: true,
                crossDomain: true,
                beforeSend: function (xhr) {
                    xhr.setRequestHeader("Authorization", "Basic " + btoa(":" + self.token));
